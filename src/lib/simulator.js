import { evaluateCompliance, REGULATORY_LIMITS } from "./regulatory.js";

export { REGULATORY_LIMITS };
...
export function simulateLoan(input) {
  ...
  const compliance = evaluateCompliance({
    annualRate: params.annualRate * 100, // params.annualRate viene normalizado (dividido entre 100)
